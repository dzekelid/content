...
- name: Google Doubleclick API Get Content Category
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/content/master/_listings/google-doubleclick/userprofiles-profileid-contentcategories-patch.md
x-common:
