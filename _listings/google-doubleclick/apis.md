...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/content/master/_listings/google-doubleclick/userprofiles-profileid-contentcategories-get.md
x-common:
