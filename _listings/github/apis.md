...
- name: Github
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/content/master/_listings/github/repos-owner-repo-contents-path-put.md
- name: Github Get Repos Owner Repo Contents Path
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/content/master/_listings/github/repos-owner-repo-contents-path-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/content/master/_listings/github/repos-owner-repo-contents-path-get-postman.md
x-common:
- type: x-net-library
